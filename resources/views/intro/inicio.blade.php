...
@section('content')
    ...
    <body class="bg-blueGray-100 ">
        ...
        <div class="px-32 py-6 border-t-4 grid grid-cols-1 md:grid-cols-5 gap-y-3 gap-x-4 divide-y-2 items-center justify-items-center bg-white">
                @php
                    $cant = 0;
            ...
            @foreach ($masElegidos as $key => $elegido)
                <div class="col-span-1 md:order-{{$order[$cant]}} h-40 md:h-{{$heights[$cant]}} md:w-44 rounded-2xl flex items-center justify-center" style="background: no-repeat center url({{ $elegido['img'] }});">
