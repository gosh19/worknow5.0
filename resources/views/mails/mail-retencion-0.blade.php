...
>
    ...
    >
        ...
        <h1>¡Hola {{ $user->name ?? 'Enrique Iglesias'}}! </h1>
        <h3 style="color:black;">Muchas gracias por interesarte en nuestras capacitaciones de :</h3>
    ...
    >
        ...
        <p>
            Si tenes alguna duda para realizar la inscripcion podes contactarte por 
            <a href="https://wa.me/5492236772444?text=Hola%20te%20habla%20{{$user->name ?? "nombre alumno"}}%20tengo%20dudas%20para%20inscribirme"
                style="color:rgb(132, 253, 132);font-size: 20px;"
                >
                WhatsApp</a>
            o dejarnos un numero de telefono
            contestando directamente este e-mail para que un asesor se contacte y pueda despejar tus dudas
        </p>
        <p style="color:black;">En caso que estes esperando a tener el dinero para abonar el ingreso no te preocupes que tendras el aula
        en modo de prueba hasta que desees ingresar de manera completa.</p>
        <p>Nuestro equipo de profesores te esta esperando para poder desarrollar tus habilidades
            como emprendedor/profesional. </p>
        <div
            style="background: #737373;
            height: 100%;
            position: absolute;
