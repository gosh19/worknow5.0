...
>
    ...
    >
        ...
        <h2 style="color:black">
            Por unica vez accede a los cursos de :
            ...
            <h2 style="color:black;">
                ...
                con un descuento del <span style="font-size: 30px">25%</span> utilizando el codigo {{'WN-'.$user->id.'-25'}}
            </h2>
            <h3>
                Contactate via <a href="https://wa.me/5491126942226?text=Hola%20te%20habla%20{{$user->name ?? "nombre alumno"}}%20quiero%20inscribirme%20con%20el%20descuento%20del%2025%%20,%20con%20el%20codigo%20{{'WN-'.$user->id.'-25'}}"
                    style="color:rgb(132, 253, 132);font-size: 20px;"
                    >
                    WhatsApp</a>
                     para acceder a la promocion o contesta directamente este correo con la frase QUIERO ACCEDER.
            </h3>
