...
<div class="container">
    ...
    <h1>Alumno numero: {{$user->id}}</h1>
    <form class="" action="{{route('DatosUser/editar')}}" method="post">
      @csrf
      <div class="input-group mb-3">
        <input type="text" name="id" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{$user->id}}" readonly>
      </div>
      @if (count($datosUser) != 0)
          
        <div class="input-group mb-3">
          <input type="text" name="dni" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{$datosUser[0]->dni}}" placeholder="D.N.I." required>
        </div>
        
        <div class="input-group mb-3">
            <input type="text" name="direccion" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{$datosUser[0]->direccion}}" placeholder="Direccion" required>
        </div>
        
        <div class="input-group mb-3">
            <input type="text" name="telefono" class="form-control" name="direccion" value="{{$datosUser[0]->telefono}}" placeholder="Telefono" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
        
        <div class="input-group mb-3">
            <input type="text" name="ciudad" class="form-control" value="{{$datosUser[0]->ciudad}}" placeholder="Ciudad" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
        </div>
        
        <label for="provincia">Provincia</label>
        <select class="form-control mb-3" id="provincia" name="provincia" >
            <option class="text-primary font-weight-bolder" value="{{$datosUser[0]->provincia}}">{{$datosUser[0]->provincia}}</option>
        ...
        <div class="input-group mb-3">
          <input type="text" name="CP" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{$datosUser[0]->CP}}" placeholder="Codigo Postal" required>
        </div>

        <div class="input-group mb-3">
            <input type="text" name="tarjeta" id="tc" class="form-control" id="basic-url id" onkeydown="validationCreditCard()" aria-describedby="basic-addon3" value="{{$datosUser[0]->tarjeta}}" placeholder="Tarjeta" required>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group mb-3">
              <input type="text" name="provincia" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="Provincia" required>
          </div>
